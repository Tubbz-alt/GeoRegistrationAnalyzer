/**
 * @file    Asset_Info_Widget_Local.hpp
 * @author  Marvin Smith
 * @date    9/6/2017
 */
#ifndef GEO_VIEWER_GUI_ASSET_INFO_WIDGET_LOCAL_HPP
#define GEO_VIEWER_GUI_ASSET_INFO_WIDGET_LOCAL_HPP
...
/**
 * @class Asset_Info_Widget_Local
 */
class Asset_Info_Widget_Local : public Asset_Info_Widget_Base
{
    Q_OBJECT
    ...
    public:
         ...
         * @brief Constructor
         */
        Asset_Info_Widget_Local( const Config_Param& asset_info,
         ...
         * @brief Destructor
         */
        virtual ~Asset_Info_Widget_Local();
