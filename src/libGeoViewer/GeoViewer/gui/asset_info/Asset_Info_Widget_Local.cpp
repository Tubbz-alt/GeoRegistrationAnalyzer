/**
 * @file    Asset_Info_Widget_Local.cpp
 * @author  Marvin Smith
 * @date    9/6/2017
 */
...
/*          Constructor         */
/********************************/
Asset_Info_Widget_Local::Asset_Info_Widget_Local( const Config_Param& asset_info,
                                                  QWidget*            parent)
    : Asset_Info_Widget_Base(asset_info,
                             parent),
      m_class_name("Asset_Info_Widget_Local")
{
    // Log Entry
    LOG_CLASS_ENTRY();
...
/*          Constructor         */
/********************************/
Asset_Info_Widget_Local::~Asset_Info_Widget_Local()
{
}
...
/*          Update Table Data           */
/****************************************/
void Asset_Info_Widget_Local::Update_Table_Data()
{
...
/*        Initialize the GUI        */
/************************************/
void Asset_Info_Widget_Local::Initialize_GUI()
{
    // Misc Args
    m_valid_asset = false;
...
/*          Build the Table Widget              */
/************************************************/
void Asset_Info_Widget_Local::Build_Table_Widget()
{
    // Create group box
...
/*          Build the Status Widget             */
/************************************************/
void Asset_Info_Widget_Local::Build_Status_Widget()
{
