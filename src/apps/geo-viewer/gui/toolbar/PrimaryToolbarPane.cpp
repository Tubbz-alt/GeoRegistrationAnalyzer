...
/*              Constructor             */
/****************************************/
PrimaryToolbarPane::PrimaryToolbarPane( System_Configuration::ptr_t  sys_config,
                                        QWidget*                     parent)
  : QWidget(parent),
...
/*          Initialize the GUI           */
/*****************************************/
void PrimaryToolbarPane::Initialize_GUI()
{
...
/*********************************************/
void PrimaryToolbarPane::Project_Button_Pressed()
{
...
/*          Initialize the Configuration      */
/**********************************************/
void PrimaryToolbarPane::Initialize_Configuration()
{
    // Set Default Configuration Parameters
    m_sys_config->Add_Config_Param("system.toolbar.primary_panel.title",
                                   "Main Toolbar",
                                   "#  Name for the Primary Toolbar Panel",
                                   false);

    m_sys_config->Add_Config_Param("system.toolbar.primary_panel.project_button.text",
                                   "Project\\nSettings",
                                   "#  Button Text",
                                   false );

    m_sys_config->Add_Config_Param("system.toolbar.primary_panel.project_button.icon",
                                   "gear.png",
...
/*********************************************/
void PrimaryToolbarPane::Build_Title_Widget()
{
    // Get the attributes required
    bool match_found;
    std::string title_str = m_sys_config->Query_Config_Param("system.toolbar.primary_panel.title",
                                                             match_found,
                                                             "Primary Toolbar");
...
/******************************************/
void PrimaryToolbarPane::Build_Tool_Buttons()
{
    // Get Default Sizes
    bool value_found;
    int def_button_height = m_sys_config->Query_Config_Param_Int32("system.toolbar.default.toolbutton.height", value_found);
    int def_button_width = m_sys_config->Query_Config_Param_Int32("system.toolbar.default.toolbutton.width", value_found);
    int def_icon_height = m_sys_config->Query_Config_Param_Int32("system.toolbar.default.toolbutton.icon_height", value_found);
    int def_icon_width = m_sys_config->Query_Config_Param_Int32("system.toolbar.default.toolbutton.icon_width", value_found);
